...
type implementationTableType = {
  commonApproach: string;
  fullPartialImplementation: string;
};

const data: implementationTableType[] = [
  {
    commonApproach: "",
    fullPartialImplementation: "",
  },
];

const implementationTableColumns: ColumnDef<implementationTableType>[] = [
  {
    accessorKey: "commonApproach",
    header: "Common Approach",
  },
  {
    accessorKey: "fullPartialImplementation",
    header: "Full/Partial Implementation",
  },
];
...
const ImplementationTable = () => {
  const table = useReactTable({
    data,
    columns: implementationTableColumns,
    ...
    <table className="min-w-full border border-gray-300">
      ...
      <tbody>
        ...
        table
          ...
          <tr>
            <td
              colSpan={implementationTableColumns.length}
